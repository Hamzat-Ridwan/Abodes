...
const create = () => {
  return (
    <div>
      ...
      <div className='bg-white rounded-lg p-[20px] mt-3'>
        <div className='flex flex-col w-full mb-[20px]'>
          <label htmlFor="name">Enter Property Name</label>
          <input className='border border-gray-300 rounded-lg h-[50px] p-[10px] mt-1 outline-none' type="text" name='name' />
        </div>
        <div className='flex flex-col w-full mb-[20px]'>
          <label htmlFor="name">Enter Description</label>
          <textarea placeholder='Write description' className='border p-[10px] mt-1 border-gray-300 rounded-lg h-[130px] outline-none' type="text" name='name' />
        </div>
        <div className='flex gap-[20px]'>
          <div className='flex flex-col mb-[20px] relative w-[60%]'>
            <label htmlFor="name">Select Property Type</label>
            <select name="" id="" className='border border-gray-300 rounded-lg h-[50px] p-[10px] mt-1 outline-none'>
          ...
          <div className='flex flex-col w-[40%] mb-[20px]'>
            ...
            <input className='border border-gray-300 rounded-lg h-[50px] p-[10px] mt-1 outline-none' type="number" name='name' />
          </div>
        </div>
        <div className='flex flex-col w-full mb-[20px]'>
